...
buzz_master_received %>% 
  ...
  select(Name, Class, Role, Spec, `Item Name`, `Item Slot`, `Item Type`, Boss, `Offspec (Y/N)`, ` `, `Date Received`, Phase) %>% 
  mutate(across(c(Name, Class, Role, Spec, `Item Slot`, `Offspec (Y/N)`, Phase, `Item Type`), factor)) %>% 
  ...
  datatable(class = 'display cell-border stripe hover row-border', filter = 'top', extensions = c('ColReorder', 'Scroller', 'Select', 'SearchPanes'),
            ...
            options = list(pageLength = 40,
                           ...
                           searchCols = list(NULL, NULL, NULL, NULL, NULL, NULL, list(search = '["Gear"]'), NULL, NULL , NULL, NULL, list(search = '["Phase 3"]')),
