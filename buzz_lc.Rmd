...
```{r sunburst, echo=FALSE, warning=FALSE, message=FALSE, fig.width=15, fig.height=6}
 ...
 sb1 <- sunburst(by_class_spec, width = "100%", height = 400)
 sb1
...
datatable(wishlist_aggregated %>% 
          ...
          escape = FALSE, rownames = FALSE, options = list(pageLength = 25, colReorder = TRUE, deferRender = TRUE, scrollY = 500, scroller = TRUE, dom = 'Blfrtip',
                        buttons = c('copy', 'csv', 'excel')),
