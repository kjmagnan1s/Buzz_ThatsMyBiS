...
buzz_received_table <- buzz_master_received %>% select(Name, Class, Role, Spec, `Item Name`, Boss, `Item Slot`, `Offspec (Y/N)`, ` `, `Date Received`, Phase)
...
datatable(buzz_received_table %>% 
            ...
            options = list(pageLength = 40, 
                         ...
                         colReorder = TRUE, deferRender = TRUE, scrollY = 500, scroller = TRUE, order = 
                           list(list(9, 'desc')),
                         searchCols = list(
                           NULL, NULL, NULL, NULL, NULL, NULL, list(search = '["N"]'), NULL, NULL, NULL, list(search = '["Phase 3"]'))),
...
datatable(wishlist_aggregated %>% 
            ...
            mutate(across(c(`Item Slot`, Boss),factor)) %>% 
            #factor item slot
